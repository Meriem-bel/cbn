          ...
          <div className="mr-20 ml-5 w-full">
            ...
            <div className="mt-7 h-2/6 w-full flex">
              ...
              <div className="ml-5 w-1/3 bg-[#008080] rounded-3xl">
                <h1 className="m-auto text-center pt-4 font-['poppins'] text-3xl font-bold text-[#006060]">Age</h1>
                <h1 className="m-auto text-center pt-3 font-['poppins'] text-6xl font-bold text-[#FFFFFF]">69</h1>
                <h1 className="m-auto text-center pt-0 font-['poppins'] text-3xl font-bold text-[#FFFFFF]">Years</h1>
                <h1 className="m-auto text-center pt-4 font-['poppins'] text-3xl font-bold text-[#006060]">Weight</h1>
                <h1 className="m-auto text-center pt-3 font-['poppins'] text-6xl font-bold text-[#FFFFFF]">82</h1>
                <h1 className="m-auto text-center pt-0 font-['poppins'] text-3xl font-bold text-[#FFFFFF]">KG</h1>
              </div>
            </div>
            ...
            <div className="mt-7 h-2/6 w-full bg-white rounded-3xl">
